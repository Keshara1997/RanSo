...
export const environment = {
  ...
  baseApiUrls:
    loadedEnv['fineractApiUrls'] || 'https://demo.mifos.community,https://52.207.60.240:8443,' + window.location.origin,
  ...
  tenantLogoUrl: loadedEnv['tenantLogoUrl'] || 'assets/images/ranso-logo.svg',
  tenantLogoUrlDark: loadedEnv['tenantLogoUrlDark'] || 'assets/images/ranso-logo-dark.svg',
